...
Route::middleware(['auth', 'role.selected'])->group(function () {
    ...
    Route::resource('banks', BankController::class)->except(['show'])->middleware('permission:menu.master-bank');
    ...
    Route::post('fund-requests/{fund_request}/resubmit', [FundRequestController::class, 'resubmit'])->name('fund-requests.resubmit');
