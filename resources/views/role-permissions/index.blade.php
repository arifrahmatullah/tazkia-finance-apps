...
@php
    ...
    $permDescriptions = [
        ...
        'menu.rekonsiliasi-bank'  => 'Cocokkan saldo kas/bank aplikasi dengan rekening koran',
        'menu.jurnal-umum'        => 'Kelola jurnal umum & posting jurnal',
        'menu.coa'                => 'Kelola Bagan Akun (daftar akun)',
        'menu.aset-tetap'         => 'Kelola aset tetap & proses penyusutan bulanan',
        'menu.laporan'            => 'Laporan pengajuan dana, pencairan dana, & realisasi anggaran (khusus Keuangan)',
        'menu.laporan-akuntansi'  => 'Laporan buku besar, neraca saldo, laba rugi, neraca, & arus kas',
