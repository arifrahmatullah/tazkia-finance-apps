...
<p class="text-sm text-slate-400 mb-5">Kamu memegang lebih dari satu jabatan. Pilih jabatan untuk menentukan departemen pengajuan dana yang akan dibuat.</p>

<div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
    @foreach($positions as $ep)
    <a href="{{ route('fund-requests.create', ['department_id' => $ep->position->department_id]) }}"
