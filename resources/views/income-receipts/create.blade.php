<x-layouts.app title="Catat Realisasi Penerimaan">
...
<h1 class="text-xl font-bold text-slate-900 mb-1">Catat Realisasi Penerimaan</h1>
...
<div class="bg-white rounded-xl shadow-sm p-6 max-w-xl">
    ...
    <form method="POST" action="{{ route('income-receipts.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="flex flex-col gap-1.5 mb-4">
        ...
        <input type="text" name="description" value="{{ old('description') }}" placeholder="Keterangan penerimaan yang benar-benar masuk"
    ...
    <div class="flex flex-col gap-1.5 mb-2">
        ...
        <p class="text-[11px] text-slate-400">PDF/JPG/PNG, maks 10 MB. Mis. bukti transfer atau kwitansi.</p>
    ...
    <div class="flex gap-3 justify-end pt-5 border-t border-slate-100">
        ...
        <button type="submit" class="px-6 py-2.5 rounded-xl text-sm font-semibold bg-gradient-to-br from-orange-400 to-orange-500 text-white border-0 cursor-pointer hover:-translate-y-px transition-all">Simpan Realisasi</button>
    </div>
    </form>
</div>
