    ...
    <div style="max-width:640px;">
        ...
        <div style="background:#fff; border-radius:14px; border:1px solid #f1f5f9; box-shadow:0 1px 4px rgba(0,0,0,0.04); overflow:hidden;">
            ...
            <div style="padding:20px 24px; border-bottom:1px solid #f1f5f9; background:linear-gradient(135deg,#040f2e,#0d2d6b); display:flex; align-items:center; gap:12px;">
                ...
                <div>
                    <div style="color:#fff; font-weight:600; font-size:0.95rem;">Edit: {{ $organization->name }}</div>
                    <div style="color:#93c5fd; font-size:0.72rem; margin-top:1px;">Perbarui data organisasi</div>
                </div>
            </div>

            <form method="POST" action="{{ route('organizations.update', $organization) }}" style="padding:24px;">
                @csrf @method('PUT')
                ...
                <div style="margin-top:16px;">
                    <label style="display:flex; align-items:center; gap:10px; cursor:pointer;">
                        ...
                        <span style="font-size:0.85rem; font-weight:500; color:#374151;">Organisasi Aktif</span>
                    </label>
                </div>
