<x-layouts.app title="Tambah Bank" breadcrumb="Master Data / Bank / Tambah">
    ...
    <div class="max-w-[680px]">
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <div class="px-6 py-5 bg-gradient-to-br from-[#040f2e] to-[#0d2d6b] flex items-center gap-3">
                ...
                <div>
                    <div class="text-white font-semibold text-[0.95rem]">Tambah Bank</div>
                    <div class="text-blue-300 text-[11px] mt-px">Tambahkan bank baru ke daftar pilihan bank</div>
                </div>
            </div>
