    ...
    <div class="flex-1 flex items-center justify-center p-10">
        <div class="w-full max-w-[360px]">
            ...
            <a href="{{ route('auth.google') }}"
               class="mt-4 flex w-full items-center justify-center gap-3 py-[11px] px-4 rounded-[10px] border border-slate-200 bg-white text-slate-700 text-[0.87rem] font-medium no-underline hover:bg-slate-50 hover:border-slate-300 transition-all">
